...
const Practice2 = () => {
    return(
        <div className="div-lecture">
            ...
            <table align="center">
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}>гейт Адамара</div>
                        </th>
                        <th>
                    ...
                    <tr>
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}} ><p className="gateY"></p></div>
                        </th>
                        <th>
                    ...
                    <tr>
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}><p className="gateZ"></p></div>
                        </th>
                        <th>
            ...
            <p>4. Используя однокубитный гейт <i><b>Rx</b></i> получите кубит в состоянии суперпозиции α|0⟩ + β|1⟩ в соответствии с вариантом, представленном в таблице 2. Выполните симуляцию. Выполните их математическое обоснование результата.</p>
            ...
            <table align="center">
                <tbody>
                    <tr>
                        ...
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}><p>Вероятность состояния |0⟩</p></div>
                        </th>
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}><p>Вероятность состояния |1⟩</p></div>
                        </th>
                    </tr>
                    <tr>
                        <th>
            ...
            <p>5. Используя однокубитный гейт <i><b>Ry</b></i> получите кубит в состоянии суперпозиции α|0⟩ + β|1⟩ в соответствии с вариантом, представленном в таблице 2. Выполните симуляцию. Выполните их математическое обоснование результата.</p>
            <p>6. Используя однокубитный гейт <i><b>U3</b></i> получите кубит в состоянии суперпозиции α|0⟩ + β|1⟩ в соответствии с вариантом, представленном в таблице 2. Выполните симуляцию. Выполните их математическое обоснование результата.</p>
            <p>7. Используя однокубитный гейт <i><b>Rx</b></i> получите кубит в состоянии суперпозиции α|0⟩ - β|1⟩ в соответствии с вариантом, представленном в таблице 2. Выполните симуляцию. Выполните их математическое обоснование результата.</p>
            <p>8. Используя однокубитный гейт <i><b>Ry</b></i> получите кубит в состоянии суперпозиции α|0⟩ - β|1⟩ в соответствии с вариантом, представленном в таблице 2. Выполните симуляцию. Выполните их математическое обоснование результата.</p>
            <p>9. Используя однокубитный гейт <i><b>U3</b></i> получите кубит в состоянии суперпозиции -α|0⟩ + β|1⟩ в соответствии с вариантом, представленном в таблице 2. Выполните симуляцию. Выполните их математическое обоснование результата.</p>
            ...
            <table align="center">
                <tbody>
                    <tr>
                        ...
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}><p>Вероятность состояния |0⟩ первого кубита</p></div>
                        </th>
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}><p>Вероятность состояния |0⟩ второго кубита</p></div>
                        </th>
                        <th>
                            <div align="center" style={{margin: "10px", paddingLeft: "30px", paddingRight: "30px"}}><p>Вероятность состояния |0⟩ третьего кубита</p></div>
                        </th>
                    </tr>
                    <tr>
                        <th>
