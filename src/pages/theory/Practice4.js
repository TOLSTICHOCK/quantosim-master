...
const Practice3 = () => {
    return(
        <div className="div-lecture">
            ...
            <p>4. В системе <i>QSIM</i> реализуйте алгоритм Дойча для функций <i>f</i><sub>1</sub>(<i>x</i>)=0, <i>f</i><sub>2</sub>(<i>x</i>)=1, <i>f</i><sub>3</sub>(<i>x</i>)=<i>x</i> и <i>f</i><sub>3</sub>(<i>x</i>)=<i>х</i>. Выполните симуляцию для каждой функции и обоснование полученных результатов.</p>
            ...
            <p>6. В системе <i>QSIM</i> реализуйте алгоритм Дойча для функции <i>f</i>(<i>x</i><sub>1</sub>,<i>x</i><sub>2</sub>)=<i>x</i><sub>1</sub> ⊕ <i>x</i><sub>2</sub>. Выполните симуляцию и обоснование полученных результатов.</p>
            ...
            <p>8. В системе <i>QSIM</i> реализуйте алгоритм Дойча для функции <i>f</i>(<i>x</i><sub>1</sub>,<i>x</i><sub>2</sub>)=<i>x</i><sub>1</sub> ⊕ <i>x</i><sub>2</sub>. Выполните симуляцию и обоснование полученных результатов.</p>        
            ...
            <p>10. В системе <i>QSIM</i> реализуйте оракул функции <i>f</i>(<i>x</i><sub>1</sub>,<i>x</i><sub>2</sub>)=<i>x</i><sub>1</sub> ⋁ <i>x</i><sub>2</sub> и реализуйте алгоритм Гровера. Выполните симуляцию и обоснование полученных результатов.</p>
